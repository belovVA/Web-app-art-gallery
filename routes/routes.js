...
setRoute('/editArt', 'moderator/editArt/editArt.html');
setRoute('/login', 'LoginOrRegistration/logReg.html');
setRoute('/checkArts', 'moderator/checkArts/checkArts.html');
setRoute('/moderationArts', 'moderator/moderationArts/moderationArts.html');
setRoute('/myArts', 'moderator/MyArts/myArts.html');
